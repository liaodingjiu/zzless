...
<meta name="description" content="${esc(a.n)} — ${rankLabel(a.r)} ${a.e} ${a.sp}, ${a.f}. HP ${a.hp||'—'} / ATK ${a.atk||'—'} / DEF ${a.def||'—'} at Lv.60.">
...
<script type="application/ld+json">
{
  ...
  "@type":"WebPage",
  "name":"${esc(a.n)} — ${a.e} ${a.sp}",
  "description":"${esc(a.n)} — ${rankLabel(a.r)} ${a.e} ${a.sp}, ${a.f}. Base stats at Lv.60.",
  "url":"https://zzless.com/agents/${a.s}/",
