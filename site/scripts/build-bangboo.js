...
<meta property="og:title" content="${esc(bb.n)} — Bangboo | ZZZ Database">
<meta property="og:description" content="${esc(bb.n)} — ${rankLabel(bb.r)} ${bb.e} Bangboo. ${esc(bb.sk)}: ${esc(bb.skd)}">
<meta property="og:image" content="https://zzless.com/images/bangboo/${bb.s}.png">
<meta property="og:url" content="https://zzless.com/bangboo/${bb.s}/">
<meta property="og:type" content="article">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="${esc(bb.n)} — Bangboo | ZZZ Database">
<meta name="twitter:description" content="${esc(bb.n)} — ${rankLabel(bb.r)} ${bb.e} Bangboo. ${esc(bb.sk)}.">
<meta name="twitter:image" content="https://zzless.com/images/bangboo/${bb.s}.png">
...
<script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","@id":"https://zzless.com/bangboo/${bb.s}/#webpage","name":"${esc(bb.n)} — Bangboo","description":"${esc(bb.n)} — ${rankLabel(bb.r)} ${bb.e} Bangboo. ${esc(bb.sk)}: ${esc(bb.skd)}","url":"https://zzless.com/bangboo/${bb.s}/","isPartOf":{"@type":"WebSite","name":"ZZZ Database","url":"https://zzless.com"}}</script>
<script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://zzless.com/"},{"@type":"ListItem","position":2,"name":"Bangboo","item":"https://zzless.com/bangboo/"},{"@type":"ListItem","position":3,"name":"${esc(bb.n)}"}]}</script>
